...
type DatabaseRepo interface {
	...
	SearchAvailabilityByDatesByRoomID(startDT, endDT time.Time, roomID int) (bool, error)
	SearchRoomAvailabilityForAllRooms(startDT, endDT time.Time) ([]models.Room, error)
}
